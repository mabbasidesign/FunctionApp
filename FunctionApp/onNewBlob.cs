...
namespace FunctionApp.AzureFuncs
{
    public class OnNewBlob
    {
        ...
        public async Task Run([BlobTrigger("ticket/{name}", Connection = "AzureWebJobsStorage")]
        ...
        public async Task OnNewBlob2([BlobTrigger("ticket2/{name}", Connection = "AzureWebJobsStorage")]
